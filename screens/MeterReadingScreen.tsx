...
import { Picker, View, StyleSheet, Text, TextInput, Button } from 'react-native'
...
export default function MeterReadingScreen() {
    ...
    const [accounts, setAccounts] = useState([
      ...
      const [selectedAccount, setselectedAccount] = useState<any>({name: '', number: '', personName: '', address: ''});
      ...
      const submit = () => {
        ...
        return (
            ...
            <Picker style={{ height: 40, borderColor: 'gray', borderWidth: 1 }} onValueChange={(text: any) => dropDownUse(text)} selectedValue={selectedAccount}>   
             ...
             {displayInputs ? <View>   
               ...
               <Text style={style.modalText}>Account No : {selectedAccount.number}</Text> 
              <Text style={style.modalText}>Personal Name : {selectedAccount.personName}</Text>
              <Text style={style.modalText}>Address : {selectedAccount.address}</Text>
              </View>
              <Text style={style.modalText}>Complaint category  : </Text> 
               ...
               <Picker.Item label="- select category -" value="0" />
                ...
                />   
                    ...
                    <Button title="Submit" color="green" onPress={() => submit()}></Button> 
           </View> : '' }
