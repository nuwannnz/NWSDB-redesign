    ...
    <View style={style.container}>
      <View style={style.buttons}>
        <Button
          ...
          title="By Account No"
          onPress={() => handleByAccountNo()}
        ></Button>
        <Button
          disabled={disableComplaintBtn}
          title="By Complaint ID"
          onPress={() => handleByComplaintID()}
        ></Button>
      </View>

      {byAccountNo ? <StatusByAccountID /> : null}
      {byComplaintID ? <StatusByComplaintID /> : null}
    </View>
  );
}
